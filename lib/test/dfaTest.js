...
test.get_next_state_on_specific_inout = function() {
	...
	var nextStateOn0 = state_S.getStateForInput("0");
	var nextStateOn1 = state_S.getStateForInput("1");

	assert.deepEqual(nextStateOn0.name, "S")
	assert.deepEqual(nextStateOn1.name, "A")
